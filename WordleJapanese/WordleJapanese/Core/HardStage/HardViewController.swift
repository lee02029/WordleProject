...
class HardGameViewController: UIViewController {
    let answers = ["あおいえお", "くこさしえ", "けしおかき", "のくけこせ"]
    ...
    let keyboardVC = HardKeyboardViewController()
    let boardVC = HardBoardViewController()
...
extension HardGameViewController: HardKeyboardViewControllerDelegate {
    
    func HardkeyboardViewController(_ vc: HardKeyboardViewController, didTapKey letter: Character) {
...
extension HardGameViewController: HardBoardViewControllerDatasource {
