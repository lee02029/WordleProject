...
protocol EasyBoardViewControllerDatasource: AnyObject {
    var currentGuesses: [[Character?]] { get }
    func boxColor(at indexPath: IndexPath) -> UIColor?
}

class EasyBoardViewController: UIViewController {
    weak var datasource: EasyBoardViewControllerDatasource?
...
extension EasyBoardViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
